...
func (info *recordInfo) AddDoubleField(name string, source string) string {
	return info.addField(name, source, 8, 0, DoubleType, 9)
}
...
func (info *recordInfo) addField(name string, source string, size int, scale int, fieldType string, fixedLen uintptr) string {
